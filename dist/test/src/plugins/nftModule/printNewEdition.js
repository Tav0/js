...
exports.printNewEditionOperationHandler = {
    handle: (operation, metaplex) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const newAssociatedToken = yield (0, spl_token_1.getAssociatedTokenAddress)(newMint.publicKey, newOwner, false, tokenProgram, associatedTokenProgram);
        const sharedInput = {
            lamports,
            edition,
            newMint,
        ...
        if (operation.input.via === 'vault') {
            ...
            const originalTokenAccount = (_b = operation.input.originalTokenAccount) !== null && _b !== void 0 ? _b : (yield (0, spl_token_1.getAssociatedTokenAddress)(originalMint, originalTokenAccountOwner.publicKey, false, tokenProgram, associatedTokenProgram));
